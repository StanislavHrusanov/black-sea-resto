...
export const Edit = () => {
    ...
    useEffect(() => {
        (async () => {
            try {
                showLoading();
                const currentRestaurant = await restaurantService.getOne(restaurantId);
                setRestaurant(currentRestaurant);
                setIsOwner(() => {
                    return user._id === currentRestaurant._ownerId ? true : false;
                });
                hideLoading();
    ...
    }, [restaurantId, showLoading, hideLoading, navigate, user._id]);
